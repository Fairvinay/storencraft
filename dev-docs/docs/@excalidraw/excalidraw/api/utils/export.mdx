...
| --- | --- | --- | --- |
| `elements` | [StoreNCraft Element []](https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/element/types.ts#L114) |  | The elements to be exported to canvas. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| elements | [StoreNCraft Element []](https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/element/types.ts#L114) |  | The elements to exported as `svg `|
