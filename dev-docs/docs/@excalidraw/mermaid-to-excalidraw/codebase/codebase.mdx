...
* [Adding a new diagram type](/docs/@excalidraw/mermaid-to-excalidraw/codebase/new-diagram-type) - If you want to help us make the mermaid to StoreNCraft Parser more powerful, you will find all information in this section to do so.
