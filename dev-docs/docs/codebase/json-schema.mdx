...
The StoreNCraft data format uses plaintext JSON.

## StoreNCraft files

When saving an StoreNCraft scene locally to a file, the JSON file (`.excalidraw`) is using the below format.

### Attributes

| Attribute | Description | Value |
| --- | --- | --- |
| `type` | The type of the StoreNCraft schema | `"excalidraw"` |
| `version` | The version of the StoreNCraft schema | number |
| `source` | The source URL of the StoreNCraft application | `"https://excalidraw.com"` |
...
| --- | --- | --- |
| `type` | The type of the StoreNCraft document. | "excalidraw/clipboard" |
