...
const config = {
  title: "StoreNCraft developer docs",
  tagline:
    "For StoreNCraft contributors or those integrating the StoreNCraft editor",
  url: "https://docs.excalidraw.com",
  baseUrl: "/",
  onBrokenLinks: "throw",
  onBrokenMarkdownLinks: "warn",
  favicon: "img/favicon.png",
  organizationName: "StoreNCraft", // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © 2023 StoreNCraft community. Built with Docusaurus ❤️`,
      },
      prism: {
