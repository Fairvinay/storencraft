...
const FeatureList = [
  {
    title: "Learn how StoreNCraft works",
    Svg: require("@site/static/img/undraw_innovative.svg").default,
    description: (
      <>Want to contribute to StoreNCraft but got lost in the codebase?</>
    ),
  },
  {
    title: "Integrate StoreNCraft",
    Svg: require("@site/static/img/undraw_blank_canvas.svg").default,
    description: (
      <>
        Want to build your own app powered by StoreNCraft but don't know where to
        start?
      </>
    ),
  },
