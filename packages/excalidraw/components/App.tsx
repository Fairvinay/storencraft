  ...
  private onWindowMessage(event: MessageEvent) {
    ...
    switch (event.origin) {
      case "https://player.vimeo.com":
        //Allowing for multiple instances of StoreNCraft running in the window
          ...
          return (
            ...
            >
              <div
                ...
                //https://github.com/storencraft/storencraft/pull/6691#issuecomment-1607383938
                /*ref={(ref) => {
                ...
                >
                  {(isEmbeddableElement(el)
                    ...
                    <iframe
                      ...
                      title="StoreNCraft Embedded Content"
  ...
  private handleCanvasPointerMove = (
    ...
    if (
      ...
      if (
        ...
        // update the state. Check https://github.com/storencraft/storencraft/pull/5508 for more details.
        flushSync(() => {
          this.setState({
