        ...
        <form onSubmit={onSubmit}>
          <div className="publish-library-note">
            <Trans
              ...
              link={(el) => (
                <a
                  href="https://libraries.storencraft.netlify.app"
                  target="_blank"
                  rel="noopener"
                >
                  {el}
          ...
          <span className="publish-library-note">
            <Trans
              ...
              link={(el) => (
                <a
                  href="https://github.com/storencraft/storencraft-libraries#guidelines"
                  target="_blank"
          ...
          <div className="publish-library__fields">
            ...
            <span className="publish-library-note">
              <Trans
                ...
                link={(el) => (
                  <a
                    href="https://github.com/storencraft/storencraft-libraries/blob/main/LICENSE"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    {el}
